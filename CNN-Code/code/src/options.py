...
class ModelOptions:
    def __init__(self):
        parser = argparse.ArgumentParser(description='Classification of melanoma histology')
        parser.add_argument('--dataset-path', type=str, default='/home/tbiancal/melanoma_images/2021_1_7_set',  help='dataset path (default: ./dataset)')
        parser.add_argument('--testset-path', type=str, default='./home/tbiancal/melanoma_images/2021_1_7_set/test', help='file or directory address to the test set')
